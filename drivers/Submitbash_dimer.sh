...
for NumSeg in $(seq 1 122)
do
cd /u/home/k/katiebog/GitHub/Data/polymer-c_data/dimer.${d}
mkdir run.${what}.N${NumSeg}_${d}
cd /u/home/k/katiebog/GitHub/polymer-c/src/PolymerCode
cp metropolis.out parameters.txt ISEED /u/home/k/katiebog/GitHub/Data/polymer-c_data/dimer.${d}/run.${what}.N${NumSeg}_${d}
cd /u/home/k/katiebog/GitHub/polymer-c/drivers
cp submit.${what}.N${NumSeg}.${d}.sh /u/home/k/katiebog/GitHub/Data/polymer-c_data/dimer.${d}/run.${what}.N${NumSeg}_${d}
cd /u/home/k/katiebog/GitHub/polymer-c/drivers
...
for NumSeg in $(seq 1 122)
do
cd /u/home/k/katiebog/GitHub/Data/polymer-c_data/dimer.${d}/run.${what}.N${NumSeg}_${d}
