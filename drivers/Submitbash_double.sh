...
for NumSeg in $(seq 1 200)
do
cd /u/home/k/katiebog/Data/double.${d}
mkdir run.${what}.N${NumSeg}_${d}
cd /u/home/k/katiebog/test/src/PolymerCode
cp metropolis.out parameters.txt ISEED submit.${what}.N${NumSeg}.${d}.sh /u/home/k/katiebog/Data/double.${d}/run.${what}.N${NumSeg}_${d}
cd /u/home/k/katiebog/test/src/PolymerCode
...
for NumSeg in $(seq 1 200)
do
cd /u/home/k/katiebog/Data/double.${d}/run.${what}.N${NumSeg}_${d}
