...
for NumSeg in $(seq 136 142)
do
cd /data/homezvol0/kbogue1/GitHub/Data/polymer-c_data/dimer.${d}
mkdir run.${what}.N${NumSeg}_${d}
cd /data/homezvol0/kbogue1/GitHub/polymer-c/src/PolymerCode
cp metropolis.out parameters.txt ISEED /data/homezvol0/kbogue1/GitHub/Data/polymer-c_data/dimer.${d}/run.${what}.N${NumSeg}_${d}
cd /data/homezvol0/kbogue1/GitHub/polymer-c/drivers
cp submit.${what}.N${NumSeg}.${d}.sub /data/homezvol0/kbogue1/GitHub/Data/polymer-c_data/dimer.${d}/run.${what}.N${NumSeg}_${d}
cd /data/homezvol0/kbogue1/GitHub/polymer-c/drivers
...
for NumSeg in $(seq 136 142)
do
cd /data/homezvol0/kbogue1/GitHub/Data/polymer-c_data/dimer.${d}/run.${what}.N${NumSeg}_${d}
